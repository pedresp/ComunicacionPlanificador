...
#ifndef SYST_MSGS__SRV__DETAIL__ADV_SERVICE__FUNCTIONS_H_
#define SYST_MSGS__SRV__DETAIL__ADV_SERVICE__FUNCTIONS_H_
...
/// Initialize srv/AdvService message.
/**
...
/// Finalize srv/AdvService message.
/**
...
/// Create srv/AdvService message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * syst_msgs__srv__AdvService_Request__init().
...
/// Destroy srv/AdvService message.
/**
 * It calls
 * syst_msgs__srv__AdvService_Request__fini()
...
/// Check for srv/AdvService message equality.
/**
...
/// Initialize array of srv/AdvService messages.
/**
...
/// Finalize array of srv/AdvService messages.
/**
 * It calls
 * syst_msgs__srv__AdvService_Request__fini()
...
/// Create array of srv/AdvService messages.
/**
 * It allocates the memory for the array and calls
 * syst_msgs__srv__AdvService_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/AdvService messages.
/**
 * It calls
 * syst_msgs__srv__AdvService_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/AdvService message array equality.
/**
...
/// Copy an array of srv/AdvService messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * syst_msgs__srv__AdvService_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_syst_msgs
...
/**
 * It calls
 * syst_msgs__srv__AdvService_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_syst_msgs
...
/**
 * It allocates the memory for the array and calls
 * syst_msgs__srv__AdvService_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_syst_msgs
...
/**
 * It calls
 * syst_msgs__srv__AdvService_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // SYST_MSGS__SRV__DETAIL__ADV_SERVICE__FUNCTIONS_H_
