...
#include "syst_msgs/msg/detail/waypoints__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_runtime_c/primitives_sequence.h"  // wps
#include "rosidl_runtime_c/primitives_sequence_functions.h"  // wps

// forward declare type support functions


using _Waypoints__ros_msg_type = syst_msgs__msg__Waypoints;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: wps
  {
    ...
    auto array_ptr = ros_message->wps.data;
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: wps
  {
    ...
    if (ros_message->wps.data) {
      rosidl_runtime_c__double__Sequence__fini(&ros_message->wps);
    }
    if (!rosidl_runtime_c__double__Sequence__init(&ros_message->wps, size)) {
      fprintf(stderr, "failed to create array for field 'wps'");
      return false;
    }
    auto array_ptr = ros_message->wps.data;
...
size_t get_serialized_size_syst_msgs__msg__Waypoints(
  const void * untyped_ros_message,
...
static uint32_t _Waypoints__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_syst_msgs__msg__Waypoints(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_syst_msgs
size_t max_serialized_size_syst_msgs__msg__Waypoints(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = syst_msgs__msg__Waypoints;
    is_plain =
      (
...
static size_t _Waypoints__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_syst_msgs__msg__Waypoints(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, syst_msgs, msg, Waypoints)() {
