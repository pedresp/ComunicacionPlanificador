...
static const _AdvService_Request_type_support_symbol_names_t _AdvService_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, syst_msgs, srv, AdvService_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, syst_msgs, srv, AdvService_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, syst_msgs, srv, AdvService_Request)() {
  return &::syst_msgs::srv::rosidl_typesupport_c::AdvService_Request_message_type_support_handle;
}
...
static const _AdvService_Response_type_support_symbol_names_t _AdvService_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, syst_msgs, srv, AdvService_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, syst_msgs, srv, AdvService_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, syst_msgs, srv, AdvService_Response)() {
  return &::syst_msgs::srv::rosidl_typesupport_c::AdvService_Response_message_type_support_handle;
}
...
static const _AdvService_type_support_symbol_names_t _AdvService_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, syst_msgs, srv, AdvService)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, syst_msgs, srv, AdvService)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, syst_msgs, srv, AdvService)() {
  return &::syst_msgs::srv::rosidl_typesupport_c::AdvService_service_type_support_handle;
}
